...
from SafeMoE.trainers import SFTTrainer
...
def main() -> None:
    ...
    grad_save_path = os.path.join(args.output_dir, "gradient.json")
    with open(grad_save_path, "w") as f:
        json.dump(trainer.grad_data, f)
