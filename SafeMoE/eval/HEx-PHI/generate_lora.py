...
def main() -> None:
    ...
    dataset = load_dataset("json", data_files="/root/SafeMoE/SafeMoE/datasets/raw/raw_data/HEx-PHI.json")['train']
    text_key = "text"
    ...
    results_out = [{"prompt": p, "formatted_prompts": fp, "response": r, "category": c} for p, r, fp, c in zip(prompts, results, formatted_prompts, dataset['category'])]
